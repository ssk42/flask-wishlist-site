...
- [x] **OWN-VIS-001**: While viewing the items list or dashboard, if the item belongs to the current user, the system shall hide the item's true claim status and instead display a "Your Item" badge.
