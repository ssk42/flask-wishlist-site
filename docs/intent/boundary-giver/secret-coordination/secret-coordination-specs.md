...
- [x] **GIV-SEC-007**: When a split gift organizer marks an item as purchased, the system shall notify all other contributors (excluding the organizer and the item owner).
