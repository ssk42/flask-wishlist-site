...
def test_split_gift_flow(page: Page, live_server, browser_app):
    ...
    # Scope to the specific card to avoid strict mode violations (modals also contain text)
    ...
    expect(item_card.get_by_text("Splitting")).not_to_be_visible() # Surprise protection verification
